package
{
	...
	public class Roof extends FlxSprite
	{
			[Embed(source="roof1.png")] protected var Img1:Class;
			[Embed(source="roof2.png")] protected var Img2:Class;
			[Embed(source="roof3.png")] protected var Img3:Class;
			...
			public function Roof(X:Number=0, Y:Number=0, TYPE:uint = 1)
			{
				super(X, Y);
